...
if __name__ == "__main__":
    spark = (SparkSession.builder
             ...
             .config('spark.jars', 
                     r'C:\Users\SARUNPAX\Desktop\practice\kafka-spark-project\postgresql-42.7.4.jar')
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr('to_json(struct(*)) AS value') \
        ...
        .option('checkpointLocation', r'C:\Users\SARUNPAX\Desktop\practice\kafka-spark-project\checkpoints\checkpoint1') \
        .outputMode('update') \
        .start()
    turnout_by_location_to_kafka = turnout_by_location.selectExpr('to_json(struct(*)) AS value') \
        ...
        .option('checkpointLocation', r'C:\Users\SARUNPAX\Desktop\practice\kafka-spark-project\checkpoints\checkpoint2') \
        .outputMode('update') \
        .start()
